...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        # self.window.config(text='Score:0')
        self.score_label = Label(
            text='Score:0', bg=THEME_COLOR, foreground='white',font=('Arial',15,'bold'))
        self.score_label.grid(row=0, column=1)

        self.canvas = Canvas(width=300, height=250)
        self.question_text = self.canvas.create_text(150, 125, text='placeholder',
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text,text="You're reached the end of the question")
